...
List<WebElement> list_Menu = driver.findElement(By.xpath("//li[@class='main-menu-first-level-list-item']//b\"));
		
		//list_Menu.get(0).click();
		
		//La lista de elemetos guardala en este objeto
//		for(WebElement object : list_Menu) {
//			
//		}
		//Se delcara la variable opcion donde pondremos el nombre de la opcion que queremos
		String option="Admin";
		System.out.print("La cantidad de la lista es :" + list_Menu.size()); //Imprime los elementos de la lista
		System.out.print("La opcion seleccionada es :" + option);
		for(int i = 0; i<list_Menu.size(); i++) {
		System.out.print(list_Menu.get(i).getText());
